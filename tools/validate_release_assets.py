"""Static release-asset validation for the Prithvi-EO-1.0 crop-classification DIMER pipeline.
...
REPO_NAME = "prithvi-crop-classification-pipeline"
NOTEBOOK_NAME = "prithvi_crop_classification_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "ibm-nasa-geospatial/Prithvi-EO-1.0-100M-multi-temporal-crop-classification"
...
# The dataset revision and the vendored upstream commit are cited beside the model pin.
KNOWN_SHAS: frozenset[str] = frozenset(
    {"f285bb27c8f623a0fb6a44a6fd953c3ad34007d6", "3b6d401f3b4527059af0e44bd640225285e1933d"}
)
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/prithvi_crop_classification_sample_chip.tif",
    "outputs/prithvi_crop_classification_sample_label.tif",
    "outputs/prithvi_crop_classification_sample_pairs.csv",
    "outputs/prithvi_crop_classification_evaluation_report.json",
    "outputs/prithvi_crop_classification_predictions.json",
    "outputs/prithvi_crop_classification_adapter",
    "outputs/prithvi_crop_classification_result.json",
)
CODE_MARKERS = (
...
MARKDOWN_MARKERS = (
    ...
    "inert stand-ins",
    "selected on these chips",
    "majority-class baseline",
    "no `extractall`",
    "not calibrated probabilities",
    "BatchNorm",
    "Split by region, not by chip",
    "sample-sanity",
    "CC BY 4.0",
)
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    1_808_174: "one _merged.tif chip in validation_chips.tgz (224x224x18 int16)",
    21_249_580: "adapter.safetensors from save_artifact (default config, Kaggle run 2026-09-19)",
    111_617_880: "total of the 120 pinned validation_chips.tgz members (60 chips + 60 masks)",
    537_722_508: "converted prithvi-eo-1.0-100m-crop.safetensors (regenerated, not staged)",
    1_179_542_384: "validation_chips.tgz, ibm-nasa-geospatial/multi-temporal-crop-classification@f285bb2",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "465513635354b8c8a9c4bfd4a37b39d5306eb8ec63527905ce0195075d04108d": "pickle-audit digest of multi_temporal_crop_classification_Prithvi_100M.pth globals",
    "d1df8044700a0d1e00b11b1fbac66e0495cf6647e1632a858c003eaf4b5ce36d": "converted prithvi-eo-1.0-100m-crop.safetensors (regenerated)",
    "d6e616cc008858a1935a8937e0cdf852d574754273b0655fb696bd29aebd2fd3": "validation_chips.tgz, ibm-nasa-geospatial/multi-temporal-crop-classification@f285bb2",
}
